...
class ControllerOpenbayAmazon extends Controller {
	...
	public function stockUpdates() {
		...
		$this->initTpl('openbay/amazon_stock_updates');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function overview() {
		...
		$this->initTpl('openbay/amazon_overview');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function subscription() {
		...
		$this->initTpl('openbay/amazon_subscription');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function settings() {
		...
		$this->initTpl('openbay/amazon_settings');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function itemLinks() {
		...
		$this->initTpl('openbay/amazon_item_links');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function savedListings() {
		...
		$this->initTpl('openbay/amazon_saved_listings');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function bulkListProducts() {
		...
		$this->initTpl('openbay/amazon_bulk_listing');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function bulkLinking() {
		...
		$this->initTpl('openbay/amazon_bulk_linking');
		$this->children = array(
			'common/header',
			'common/footer'
		);
