...
class ControllerOpenbayAmazonProduct extends Controller {
	private $route = 'openbay/amazon_product';
	private function loadText($route = '') {
		if($route != ''){
			$this->loadLang ( $route );
		}else{
		$this->loadLang ( 'openbay/amazon_product' ); }
	}
	public function index() {
		...
		$savedListingData = $this->model_openbay_amazon->getProduct_($product_id, $variation);
		...
		$this->initTpl('openbay/amazon_listing_advanced');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function fillSavedValues($product_id, $fields_array, $var = '') {
		...
		$this->load->model('openbay/amazon');
		$savedListing = $this->model_openbay_amazon->getProduct_($product_id, $var);
