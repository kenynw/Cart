...
class ControllerOpenbayAmazonus extends Controller {
	private $route = 'openbay/amazonus';
	public function stockUpdates() {
		...
		$this->initTpl('openbay/amazonus_stock_updates');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function overview() {
		...
		$this->initTpl('openbay/amazonus_overview');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function subscription() {
		...
		$this->initTpl('openbay/amazonus_subscription');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function settings() {
		...
		$this->initTpl('openbay/amazonus_settings');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function itemLinks() {
		...
		$this->initTpl('openbay/amazonus_item_links');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function savedListings() {
		...
		$this->initTpl('openbay/amazonus_saved_listings');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function doBulkSearch() {
		...
		if (!empty($this->request->post['product_ids'])) {
			foreach ($this->request->post['product_ids'] as $product_id) {
				$product = $this->model_catalog_product->getProduct_($product_id);
	...
	public function bulkListProducts() {
		...
		if ($bulk_listing_status) {
			...
			foreach ($results as $result) {
				$product = $this->model_catalog_product->getProduct_($result['product_id']);
		...
		$this->initTpl('openbay/amazonus_bulk_listing');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function bulkLinking() {
		...
		$this->initTpl('openbay/amazonus_bulk_linking');
		$this->children = array(
			'common/header',
			'common/footer'
		);
