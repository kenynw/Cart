...
class ControllerLocalisationLengthClass extends Controller {
	...
	private $route = 'localisation/length_class';
	...
	protected function getList() {
		...
		$this->initNotice();
		$this->initTpl('localisation/length_class_list');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['length_class_id'])) {
			...
			$this->data['length_class_id'] = $length_class_info['length_class_id'];
		} else {
			$this->data['length_class_id'] = '';
		}			
		$this->initNotice();
		$this->initTpl('localisation/length_class_form');
		$this->children = array(
			'common/header',
			'common/footer'
		);
