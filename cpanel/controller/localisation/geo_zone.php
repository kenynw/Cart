...
class ControllerLocalisationGeoZone extends Controller { 
	...
	private $route = 'localisation/geo_zone';
	...
	protected function getList() {
		...
		$this->initNotice();
		$this->initTpl('localisation/geo_zone_list');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['geo_zone_id'])) {
			...
			$this->data['geo_zone_id'] = $geo_zone_info['geo_zone_id'];
		} else {
		...
		$this->initNotice();
		$this->initTpl('localisation/geo_zone_form');
		$this->children = array(
			'common/header',
			'common/footer'
		);
