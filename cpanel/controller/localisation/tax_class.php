...
class ControllerLocalisationTaxClass extends Controller {
	...
	private $route = 'localisation/tax_class';
	...
	protected function getList() {
		...
		$this->initNotice();
		$this->initTpl('localisation/tax_class_list');
		$this->children = array(
			'common/header',
			'common/footer',
		);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['tax_class_id'])) {
			...
			$this->data['tax_class_id'] = $tax_class_info['tax_class_id'];
		} else {
		...
		$this->initNotice();
		$this->initTpl('localisation/tax_class_form');
		$this->children = array(
			'common/header',
			'common/footer',
		);
