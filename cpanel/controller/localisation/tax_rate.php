...
class ControllerLocalisationTaxRate extends Controller {
	...
	private $route = 'localisation/tax_rate';
	...
	protected function getList() {
		...
		$this->initNotice();
		$this->initTpl('localisation/tax_rate_list');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['tax_rate_id'])) {
			...
			$this->data['tax_rate_id'] = $tax_rate_info['tax_rate_id'];
		} else {
		...
		$this->initNotice();
		$this->initTpl('localisation/tax_rate_form');
		$this->children = array(
			'common/header',
			'common/footer'
		);
