...
class ControllerSaleAffiliate extends Controller { 
	...
	protected function getList() {
		...
		$this->initNotice();
		$this->initTpl('sale/affiliate_list');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function getForm() {
		...
		$this->initNotice();
		$this->initTpl('sale/affiliate_form');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function transaction() {
		...
		$this->data['balance'] = $this->currency->format($this->model_sale_affiliate->getTotalTransactions($this->request->get['affiliate_id']), $this->config->get('config_currency'));
		...
		$this->initTpl('sale/affiliate_transaction');	
