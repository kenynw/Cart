...
class ControllerSaleCustomerGroup extends Controller {
	...
	private $route = 'sale/customer_group';
	...
	protected function getList() {
		...
		$this->initNotice();
		$this->initTpl('sale/customer_group_list');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['customer_group_id'])) {
			...
			$this->data['customer_group_id'] = $customer_group_info['customer_group_id'];
		} else {
			$this->data['customer_group_id'] = '';
		}
		
		$this->initNotice();
		$this->initTpl('sale/customer_group_form');
		$this->children = array(
			'common/header',
			'common/footer'
		);
