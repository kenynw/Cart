...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$product_total = $this->model_catalog_product->getTotalProducts_ ( $data );
		$results = $this->model_catalog_product->getProducts_ ( $data );
		foreach ( $results as $result ) {
			...
			$special = false;
			$product_specials = $this->model_catalog_product->getProductSpecials_ ( $result ['product_id'] );
		...
		$this->initNotice ();
		$this->initTpl ( 'catalog/product_list' );
		$this->children = array (
				'common/header',
				'common/footer' 
		);
	...
	protected function getForm() {
		...
		if (isset ( $this->request->post ['product_profiles'] )) {
			...
			$this->data ['product_profiles'] = $this->model_catalog_product->getProfiles_( $product_info ['product_id'] );
		} else {
		...
		if (isset ( $this->request->post ['manufacturer'] )) {
			...
			$manufacturer_info = $this->model_catalog_manufacturer->getManufacturer_ ( $product_info ['manufacturer_id'] );
		...
		if (isset ( $this->request->post ['product_attribute'] )) {
			...
			$product_attributes = $this->model_catalog_product->getProductAttributes_ ( $this->request->get ['product_id'] );
		} else {
		...
		if (isset ( $this->request->post ['product_option'] )) {
			...
			$product_options = $this->model_catalog_product->getProductOptions_ ( $this->request->get ['product_id'] );
		} else {
		...
		if (isset ( $this->request->post ['product_discount'] )) {
			...
			$this->data ['product_discounts'] = $this->model_catalog_product->getProductDiscounts_ ( $this->request->get ['product_id'] );
		} else {
		...
		if (isset ( $this->request->post ['product_special'] )) {
			...
			$this->data ['product_specials'] = $this->model_catalog_product->getProductSpecials_ ( $this->request->get ['product_id'] );
		} else {
		...
		if (isset ( $this->request->post ['product_related'] )) {
			...
			$products = $this->model_catalog_product->getProductRelated_ ( $this->request->get ['product_id'] );
		} else {
			$products = array ();
		}
		$this->data ['product_related'] = array ();
		foreach ( $products as $product_id ) {
			$related_info = $this->model_catalog_product->getProduct_ ( $product_id );
			if ($related_info) {
				$this->data ['product_related'] [] = array (
		...
		$this->initNotice ();
		$this->initTpl ( 'catalog/product_form' );
		$this->children = array (
				'common/header',
				'common/footer' 
		);
	...
	public function autocomplete() {
		...
		if (isset ( $this->request->get ['filter_name'] ) || isset ( $this->request->get ['filter_model'] ) || isset ( $this->request->get ['filter_category_id'] )) {
			...
			foreach ( $results as $result ) {
				$option_data = array ();
				$product_options = $this->model_catalog_product->getProductOptions_ ( $result ['product_id'] );
				foreach ( $product_options as $product_option ) {
