...
class ControllerCatalogReview extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server ['REQUEST_METHOD'] == 'POST') && $this->validateForm ()) {
			$this->model_catalog_review->addReview_ ( $this->request->post ['product_id'], $this->request->post );
	...
	protected function getList() {
		...
		$this->initNotice ();
		$this->initTpl ( 'catalog/review_list' );
		$this->children = array (
				'common/header',
				'common/footer' 
		);
	...
	protected function getForm() {
		...
		if (isset ( $this->request->post ['review_id'] )) {
			$this->data ['review_id'] = $this->request->post ['review_id'];
		} elseif (! empty ( $review_info )) {
			$this->data ['review_id'] = $review_info ['review_id'];
		} else {
			$this->data ['review_id'] = '';
		}
		...
		$this->initNotice ();
		$this->initTpl ( 'catalog/review_form' );
		$this->children = array (
				'common/header',
				'common/footer' 
		);
