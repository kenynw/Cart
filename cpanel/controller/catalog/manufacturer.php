...
class ControllerCatalogManufacturer extends Controller { 
	...
	private $route = 'catalog/manufacturer';
	...
	protected function getList() {
		...
		$results = $this->model_catalog_manufacturer->getManufacturers_($data);
		...
		$this->initNotice();
		$this->initTpl('catalog/manufacturer_list');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function getForm() {
		...
		if (isset($this->request->get['manufacturer_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$manufacturer_info = $this->model_catalog_manufacturer->getManufacturer_($this->request->get['manufacturer_id']);
		}
		...
		$this->initNotice();
		$this->initTpl('catalog/manufacturer_form');
		$this->children = array(
			'common/header',
			'common/footer'
		);
