...
class ControllerDesignBanner extends Controller {
	...
	protected function getList() {
		...
		$this->initNotice ();
		$this->initTpl ( 'design/banner_list' );
		$this->children = array (
				'common/header',
				'common/footer' 
		);
	...
	protected function getForm() {
		...
		if (isset ( $this->request->get ['banner_id'] ) && ($this->request->server ['REQUEST_METHOD'] != 'POST')) {
			$banner_info = $this->model_design_banner->getBanner_ ( $this->request->get ['banner_id'] );
		}
		$this->data ['token'] = $this->session->data ['token'];
		if (isset ( $this->request->post ['banner_id'] )) {
			$this->data ['banner_id'] = $this->request->post ['banner_id'];
		} elseif (! empty ( $banner_info )) {
			$this->data ['banner_id'] = $banner_info ['banner_id'];
		} else {
			$this->data ['banner_id'] = '';
		}
		...
		$this->initNotice ();
		$this->initTpl ( 'design/banner_form' );
		$this->children = array (
				'common/header',
				'common/footer' 
		);
