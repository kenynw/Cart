...
class ControllerPaymentPPProIframe extends Controller {
	...
	private $route = 'payment/pp_pro_iframe';
	...
	public function refund() {
		...
		$this->initTpl('payment/pp_pro_iframe_refund');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function viewTransaction() {
		...
		$this->initTpl('payment/pp_pro_iframe_transaction');
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function orderAction() {
		...
		$this->initTpl('payment/pp_pro_iframe_order');
			$this->response->setOutput($this->render());
		}
	}
