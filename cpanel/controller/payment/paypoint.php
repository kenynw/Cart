...
class ControllerPaymentPayPoint extends Controller {
	...
	private $route = 'payment/paypoint';
	...
	public function index() {
		...
		if (isset($this->request->post['text_successful'])) {
			$this->data['text_successful'] = $this->request->post['text_successful'];
		} else {
			$this->data['text_successful'] = $this->config->get('text_successful');
		}
		$this->initNotice();
