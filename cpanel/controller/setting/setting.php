...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$tplDir = DIR_ROOT . 'front/view/*';
		$directories = glob ( $tplDir, GLOB_ONLYDIR );
		...
		if (isset ( $this->request->post ['config_category_level'] )) {
			$this->data ['config_category_level'] = $this->request->post ['config_category_level'];
		} else {
			$this->data ['config_category_level'] = $this->config->get ( 'config_category_level' );
		}
		...
		$this->data ['informations'] = $rsi->getInfos ();
		...
		if (isset ( $this->request->post ['entry_meta_keywords'] )) {
			$this->data ['entry_meta_keywords'] = $this->request->post ['entry_meta_keywords'];
		} else {
			$this->data ['entry_meta_keywords'] = $this->config->get ( 'entry_meta_keywords' );
		}
		if (isset ( $this->request->post ['entry_category_level'] )) {
			$this->data ['entry_category_level'] = $this->request->post ['entry_category_level'];
		} else {
			$this->data ['entry_category_level'] = $this->config->get ( 'entry_category_level' );
		}
		if (isset ( $this->request->post ['text_level_1'] )) {
			$this->data ['text_level_1'] = $this->request->post ['text_level_1'];
		} else {
			$this->data ['text_level_1'] = $this->config->get ( 'text_level_1' );
		}
		if (isset ( $this->request->post ['text_level_2'] )) {
			$this->data ['text_level_2'] = $this->request->post ['text_level_2'];
		} else {
			$this->data ['text_level_2'] = $this->config->get ( 'text_level_2' );
		}
		if (isset ( $this->request->post ['text_level_3'] )) {
			$this->data ['text_level_3'] = $this->request->post ['text_level_3'];
		} else {
			$this->data ['text_level_3'] = $this->config->get ( 'text_level_3' );
		}
