...
class ControllerPaymentPPPayflowIframe extends Controller {
	private $route = 'payment/pp_payflow_iframe';
	...
	public function pp_return() {
		...
		$this->initTpl('payment/pp_payflow_iframe_return');
	...
	public function pp_cancel() {
		...
		$this->initTpl('payment/pp_payflow_iframe_cancel');
	...
	public function pp_error() {
		...
		$this->initTpl('payment/pp_payflow_iframe_error');
