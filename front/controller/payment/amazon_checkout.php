...
class ControllerPaymentAmazonCheckout extends Controller {
	private $route = 'payment/amazon_checkout';
	...
	public function address() {
		...
		$this->initTpl('payment/amazon_checkout_address');
	...
	public function payment_method() {
		...
		$this->initTpl('payment/amazon_checkout_payment');
	...
	public function confirm() {
		...
		$this->loadText ();
		$this->loadText ('checkout/checkout');
		...
		$this->initTpl('payment/amazon_checkout_confirm');
	...
	public function success() {
		...
		$this->data = array_merge($this->language->load($this->route), $this->data);
		$this->document->setTitle($this->language->get('heading_title'));
		...
		$this->initTpl('payment/amazon_checkout_success');
	...
	public function failure() {
		...
		$this->initTpl('payment/amazon_checkout_failure');
