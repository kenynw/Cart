...
class ControllerAccountOrder extends Controller {
	...
	public function index() {
		...
		$this->initTpl('account/order_list');
	...
	public function info() { 
		...
		if ($order_info) {
			...
			$this->data['totals'] = $this->model_account_order->getTotalOrders($this->request->get['order_id']);
			...
			$this->initTpl('account/order_info');
