...
class ModelPaymentPPExpress extends Model {
	...
	public function totalCaptured_($paypal_order_id) {
	...
	public function getOrder($order_id) {
		...
		if ($qry->num_rows) {
			...
			$order ['captured'] = $this->totalCaptured_ ( $order ['paypal_order_id'] );
			return $order;
		} else {
			return false;
		}
	...
	public function addTransaction_($transaction_data, $request_data = array()) {
