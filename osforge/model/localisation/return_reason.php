...
class ModelLocalisationReturnReason extends Model {
	...
	public function getReturnReasons_($data = array()) {
		if ($data) {
	...
	public function getTotalReturnReasons_() {
	...
	public function getDefaultReturnReason() {
		return $this->getModelDefault ( "`" . DB_PREFIX . "return_reason`" );
	}
