...
class ModelCheckoutFraud extends Model {
	public function getFraudScore($data) {
		...
		if ($fraud_info) {
			...
			/*
			 * maxmind api http://www.maxmind.com/app/ccv paypal api https://cms.paypal.com/us/cgi-bin/?cmd=_render-content&content_ID=developer/e_howto_html_IPNandPDTVariables
			 */
